...
The running record of what we've **decided**, when, and **why**. Append-only — when a decision changes, add a new entry that supersedes the old one (don't delete history).
