# Ingredient: Sunscreen / Photoprotection (INCI: varies — e.g. Zinc Oxide, Titanium Dioxide [mineral]; Avobenzone, Octocrylene, Tinosorb/bemotrizinol [organic, region-dependent])

**Researched:** 2026-06-18 · **Status:** ✅ shortlisted (the #1 evidence-based anti-aging step)
...
|---|---|---|
| Daily use slows visible skin aging (photoaging) | **Strong** — landmark RCT (Hughes 2013, Nambour): daily SPF15+ → ~24% less skin aging over 4.5 yrs vs discretionary use | [1](https://pubmed.ncbi.nlm.nih.gov/23732711/), [2](https://www.acpjournals.org/doi/abs/10.7326/0003-4819-158-11-201306040-00002) |
| Prevents sunburn / reduces UV damage | **Strong** (and the basis of OTC drug status) | [3](https://internationalmedicaljournal.org/index.php/ijmhsr/article/view/497) |
...
- **Target:** Broad-spectrum (UVA + UVB), **SPF 30–50+**, with good UVA (PA++++ / strong critical wavelength).
- **Stability:** Photostability is critical (e.g., avobenzone needs stabilizers). Mineral is inherently photostable.
- **Pairs well with:** Antioxidants (vitamin C, vitamin E, ferulic) underneath — boosts net photoprotection. Niacinamide, HA, ceramides for skin feel.
- **Conflicts:** Formulation-level (some actives can affect SPF film); requires proper SPF testing of the finished product — you cannot calculate SPF, it must be tested.
- **Sensory:** The make-or-break factor for daily adherence — elegant, non-greasy, no/low cast is the premium battleground.
...
## Claims caution
- ✅ **Allowed (with testing & OTC compliance in US):** SPF value, "broad spectrum," "helps prevent sunburn," and the monograph-permitted skin-cancer/early-aging language **only if** the product meets Broad Spectrum SPF 15+ requirements. "Helps protect against the visible signs of UV-induced aging" with substantiation.
- ⚠️ **Risky / non-compliant:** Any SPF/protection claim **without** finished-product SPF testing and OTC compliance; "sunblock," "all-day protection," "100% protection," "waterproof." For non-sunscreen products, do **not** imply they provide sun protection.
...
## Sources
1. Hughes MCB et al. *Sunscreen and Prevention of Skin Aging: A Randomized Trial.* Ann Intern Med, 2013. https://pubmed.ncbi.nlm.nih.gov/23732711/
2. *Sunscreen and Prevention of Skin Aging: A Randomized Trial.* Annals of Internal Medicine (vol 158, no 11). https://www.acpjournals.org/doi/abs/10.7326/0003-4819-158-11-201306040-00002
3. *A Comprehensive Systematic Review of the Relationship Between Sunscreen Use and Prevention of Photoaging.* IJMHSR. https://internationalmedicaljournal.org/index.php/ijmhsr/article/view/497
